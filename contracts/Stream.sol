...
contract Stream is IStream, ReentrancyGuard, CarefulMath {
        ...
        returns (uint256)
    {
        ...
        (vars.mathErr, vars.ratePerInterval) = divUInt(deposit, vars.duration);
        ...
        emit CreateStream(streamId, msg.sender, recipient, deposit, tokenAddress, startTime, stopTime, interval);
        return streamId;
    }
